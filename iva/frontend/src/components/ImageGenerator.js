...
const handleGenerateImage = async (imageData) => {
  if (!imageData.prompt || !imageData.image) {
          ...
          <div className="image-generator-steps">
            <div className="image-generator-steps">
              <div className="image-generator-step">
                ...
                <h4>Enter Prompt</h4>
                <p>Start by uploading a reference image of the product you want to generate. Then, enter a detailed text command describing how you want the final image to look.</p>
              </div>
              <div className="image-generator-step">
